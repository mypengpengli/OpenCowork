...
const messages: Record<Locale, Messages> = {
  zh: {
    ...
    'agent.status.completed': '本轮结束',
    'agent.status.failed': '执行失败',
    'agent.status.cancelled': '已停止',
    'agent.status.interrupted': '待恢复',
    'agent.artifacts': '生成或修改的文件',
    'agent.verification': '助手记录的验证依据',
    'agent.unverified': '尚未记录验证依据，请检查实际成果。',
    'agent.previewTruncated': '预览仅显示前 100,000 个字符，完整内容保存在原文件中。',
    'agent.stop': '停止任务',
    'agent.resume': '检查现场并继续',
    'agent.stopped': '任务已暂停：{{error}}。可在任务面板中检查并继续。',
    'agent.outputBudget': '单次输出上限',
    'agent.parallelReads': '并行读取数量',
    'agent.mcpServers': 'MCP 服务配置',
    'agent.mcpExample': '[{"name":"browser","enabled":true,"command":"node","args":["服务器入口.js"],"env":{},"allowed_tools":["browser_navigate","browser_snapshot"]}]',
    'agent.mcpHint': '支持本地 stdio MCP 服务。配置服务名称、启动程序、参数、环境变量与允许调用的工具。Windows 请使用 node.exe 和服务入口 JS 文件；白名单模式下仅开放 allowed_tools 中的工具。保存并应用配置后测试连接。',
    'agent.browserServer': '浏览器 MCP 服务名',
    'agent.browserHint': '填写已配置的 Playwright MCP 服务名称',
    'agent.testMcp': '测试已保存的 MCP 连接',
    'app.name': 'OpenCowork',
    'app.shortName': 'OC',
    'menu.chat': '对话',
    'menu.history': '历史',
    ...
    'main.empty.item1': '帮我修改本地文件',
    'main.empty.item2': '帮我生成一个自动跑期货量化的脚本',
    ...
    'main.progress.requestSent': '已发送请求',
    'main.progress.waiting': '等待模型响应',
    ...
    'main.attachments.pasteFailed': '粘贴图片失败：{error}',
    'main.attachmentOnly': '已添加附件',
    'main.attachments.filter.allSupported': '全部支持类型',
    'main.attachments.filter.images': '图片',
    'main.attachments.filter.documents': '文档',
    ...
    'settings.form.apiRequestFormat': '请求格式',
    'settings.form.apiRequestFormat.chatCompletions': 'Chat Completions (/chat/completions)',
    'settings.form.apiRequestFormat.responses': 'Responses (/responses)',
    'settings.form.responsesQueryParams': 'Responses Query 参数',
    'settings.form.responsesQueryParamsPlaceholder': '每行一项，格式 key=value，例如: group=codex',
    'settings.form.responsesHeaders': 'Responses 请求头',
    'settings.form.responsesHeadersPlaceholder': '每行一项，格式 key=value，例如: X-Channel=codex',
    ...
    'settings.form.toolsAllowedCommandsPlaceholder': '每行一个命令前缀，例如 git status、python "D:\\work\\trusted.py"。不支持通配符、复合命令或脚本求值。目录限制仅适用于内置文件工具，不是命令或 MCP 的系统沙箱。',
    'settings.form.toolsAllowedDirs': '允许目录',
    'settings.form.toolsAllowedDirsPlaceholder': '每行一个目录，例如: C:\\work\\files',
    'settings.form.toolsPickWorkspace': '选择工作区',
    'settings.form.toolsAllowedDirsHint': '第一行将作为默认工作区',
    ...
    'settings.form.maxContextTokens': '上下文Token上限',
    'settings.form.tokensUnit': 'tokens',
    'settings.form.maxContextTokensTip': '用于估算并控制对话打包体积，接近上限时会触发自动压缩',
    'settings.form.compressTriggerRatio': '压缩触发比例',
    'settings.form.ratioUnit': '比例',
    'settings.form.compressTriggerRatioTip': '估算使用量达到该比例时自动压缩历史（建议 0.90-0.95）',
...
需要自动化时，用 Bash 或 run_command 运行 scripts/run.ps1，并把 cwd 设置为技能目录。`,
    ...
    'history.drawer.screenshotPreview': '截图预览',
    'history.drawer.screenshotNotFound': '截图文件不存在或已被清理',
  ...
  en: {
    'agent.tasks': 'Tasks and results',
    'agent.status.running': 'Running',
    'agent.status.completed': 'Turn finished',
    'agent.status.failed': 'Failed',
    'agent.status.cancelled': 'Stopped',
    'agent.status.interrupted': 'Interrupted',
    'agent.artifacts': 'Created or modified files',
    'agent.verification': 'Verification evidence reported by the assistant',
    'agent.unverified': 'No verification evidence recorded. Inspect the actual results.',
    'agent.previewTruncated': 'Preview shows the first 100,000 characters. The original file contains the full content.',
    'agent.stop': 'Stop task',
    'agent.resume': 'Inspect and resume',
    'agent.stopped': 'Task paused: {{error}}. Inspect and resume it in the task panel.',
    'agent.outputBudget': 'Output token limit',
    'agent.parallelReads': 'Concurrent reads',
    'agent.mcpServers': 'MCP servers',
    'agent.mcpExample': '[{"name":"browser","enabled":true,"command":"node","args":["server-entry.js"],"env":{},"allowed_tools":["browser_navigate","browser_snapshot"]}]',
    'agent.mcpHint': 'Local stdio MCP servers: configure name, executable, arguments, environment and allowed tools. On Windows use node.exe and the server JS entrypoint. Whitelist mode exposes only allowed_tools. Save and apply before testing.',
    'agent.browserServer': 'Browser MCP server',
    'agent.browserHint': 'Name of a configured Playwright MCP server',
    'agent.testMcp': 'Test saved MCP connections',
    'app.name': 'OpenCowork',
    'app.shortName': 'OC',
    'menu.chat': 'Chat',
    ...
    'main.progress.requestSent': 'Request sent',
    'main.progress.waiting': 'Waiting for model response',
    ...
    'main.attachments.pasteFailed': 'Failed to paste image: {error}',
    'main.attachmentOnly': 'Attachment(s) added',
    'main.attachments.filter.allSupported': 'All supported',
    'main.attachments.filter.images': 'Images',
    'main.attachments.filter.documents': 'Documents',
    ...
    'settings.form.apiRequestFormat': 'Request Format',
    'settings.form.apiRequestFormat.chatCompletions': 'Chat Completions (/chat/completions)',
    'settings.form.apiRequestFormat.responses': 'Responses (/responses)',
    'settings.form.responsesQueryParams': 'Responses Query Params',
    'settings.form.responsesQueryParamsPlaceholder': 'One per line, key=value, e.g. group=codex',
    'settings.form.responsesHeaders': 'Responses Headers',
    'settings.form.responsesHeadersPlaceholder': 'One per line, key=value, e.g. X-Channel=codex',
    ...
    'settings.form.toolsAllowedCommandsPlaceholder': 'One command prefix per line, e.g. git status or python "D:\\work\\trusted.py". No wildcards, compound commands or eval. Directory limits cover built-in file tools, not an OS sandbox for commands or MCP.',
    ...
    'settings.form.toolsPickWorkspace': 'Pick workspace',
    'settings.form.toolsAllowedDirsHint': 'First line is used as the default workspace',
    ...
    'settings.form.maxContextTokens': 'Max Context Tokens',
    'settings.form.tokensUnit': 'tokens',
    'settings.form.maxContextTokensTip': 'Estimated context packing budget. History will be compressed near this limit.',
    'settings.form.compressTriggerRatio': 'Compression Trigger Ratio',
    'settings.form.ratioUnit': 'ratio',
    'settings.form.compressTriggerRatioTip': 'Automatically compress history when estimated usage reaches this ratio (recommended 0.90-0.95).',
...
Run scripts/run.ps1 via Bash or run_command and set cwd to the skill directory when automation is needed.`,
    ...
    'history.drawer.screenshotPreview': 'Screenshot Preview',
    'history.drawer.screenshotNotFound': 'Screenshot file not found or has been cleaned up',
